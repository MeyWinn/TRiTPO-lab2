...
2)Постоянные клиенты - пользователи, которые купили карту постоянного клиента после совершения 3-ех и более покупок. Имеют доступ к полному функционалу и получают скидки на все покупки.
